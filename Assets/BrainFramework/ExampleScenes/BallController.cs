...
public class BallController : MonoBehaviour
{
    ...
    void Stream()
    {
        //Debug.Log($"metrics: { EPOC.BRAIN.metrics } | command: { EPOC.BRAIN.command } | eyeAction: { EPOC.BRAIN.eyeAction } | upperFaceAction: { EPOC.BRAIN.upperFaceAction } | lowerFaceAction: { EPOC.BRAIN.lowerFaceAction }");
    }
    ...
    void FixedUpdate()
    {
        //Debug.LogError("METRICS HERE:!!!!!" + EPOC.BRAIN.metrics);
